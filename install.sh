...
echo "finding latest version of nvidia driver..."
latest_nvidia_driver=$(apt search nvidia | grep ^nvidia-driver | sort | tail -n 1 | cut -d'/' -f 1)
# sudo apt install nvidia-driver-418
#   but it might not be 418 anymore.
#     you have to manually figure out the latest version. thanks nvidia.
echo "found latest version of the nvidia driver:" $latest_nvidia_driver
